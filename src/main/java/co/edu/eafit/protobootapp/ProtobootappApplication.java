...
public class ProtobootappApplication {
    ...
    @GetMapping("/")
    public String index() {
        return String.format("Clase de CI-CD EAFIT Especialización. Bienvenido! Esta aplicación ayuda a elevar números a sus potencias y nos permite aprender sobre CI y CD.");
    }    
