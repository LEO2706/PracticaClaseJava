...
public class ProtobootappApplication {
    ...
    @GetMapping("/")
    public String index() {
        return String.format("Chicho Hola, Clase de CI-CD EAFIT Especialización. Bienvenido! Esta aplicación ayuda a elevar números a sus potencias y nos permite aprender sobre CI y CD.");
    }    
    ...
    public String cuadrado(@RequestParam(value = "numero", defaultValue = "0") Double numero) {
        ...
        return String.format("Hola El cuadrado de %f es %f", numero, this.calculadora.cuadrado(numero));
    }
